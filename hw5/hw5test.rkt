...
(define tests
  (test-suite
   ...
   (check-equal? (eval-exp (isaunit (int 1))) (int 0) "isaunit test1")
   ...
   (check-equal? (eval-exp (mlet* (list (cons "x" (int 10)) (cons "x" (int 1)) (cons "y" (add (var "x") (int 1)))) (var "y"))) (int 2) "mlet* test3")
